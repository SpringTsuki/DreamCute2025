...
give @p minecraft:wooden_shovel[minecraft:custom_name='{"translate":"stage.n.npc.rewards.item1"}',minecraft:lore=['{"translate":"stage.n.npc.rewards.item1_desc"}'],minecraft:rarity="common",minecraft:can_break={blocks:['minecraft:sand',"minecraft:snow"]},"minecraft:enchantments":{unbreaking:2,sharpness:1}]
