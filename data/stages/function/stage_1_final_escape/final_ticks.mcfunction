scoreboard players add #user final_challange 1

execute if score #user final_challange matches 1 run function stages:bgm/stage_1_1
execute if score #user final_challange matches 2890 run function stages:bgm/stage_1_2
