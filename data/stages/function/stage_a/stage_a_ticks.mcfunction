...
# 隐藏A关 - 音乐部分
execute as @a at @s unless entity @s[x=940,y=90,z=2740,dx=20,dy=5,dz=-26] run function stages:stage_a/stage_a_secret_bgm

execute as @a[x=940,y=90,z=2740,dx=20,dy=5,dz=-26] at @s run scoreboard players add @s stage_a_secret_bgm 1
